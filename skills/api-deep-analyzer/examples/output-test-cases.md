...
| TC-CASH-011    | Negative   | Recipient does not exist                    | recipient_id: "unknown_user"                   | 404 or 422 + recipient not found error      | HIGH     |
...
| TC-CASH-018    | Edge       | Duplicate request within 1 second           | same body sent twice immediately               | 409 Conflict or idempotent 200              | HIGH     |
...
[ASSUMPTION] : Idempotency is expected — confirm behavior with development team
```
