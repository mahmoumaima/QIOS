...
| TC-TRSF-008  | Transfer to non-existent recipient                      | Negative    | P1       | 404 — "Recipient not found" error                        | HIGH     |
...
| TC-TRSF-015  | Sender transfers to themselves                          | Negative    | P2       | 422 — self-transfer not allowed                          | MEDIUM   |
| TC-TRSF-016  | Duplicate transfer — same payload within 1 second       | Edge        | P2       | 409 Conflict                                             | HIGH     |
